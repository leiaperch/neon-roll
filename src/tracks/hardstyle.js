...
const HOOK = [
  [[0, 80, 3], [3, 83, 1], [4, 87, 4]],
  [[0, 85, 2], [2, 83, 2], [4, 80, 4]],
  [[0, 83, 3], [3, 85, 1], [4, 88, 4]],
  [[0, 87, 2], [2, 85, 2], [4, 83, 4]],
  [[0, 90, 3], [3, 87, 1], [4, 85, 4]],
  [[0, 87, 2], [2, 83, 2], [4, 80, 4]],
  [[0, 85, 3], [3, 87, 1], [4, 90, 4]],
  [[0, 88, 2], [2, 85, 2], [4, 80, 4]],
];
...
export default piste({
  ...
  pattern: motifEDM({ ACCORDS, BASSE, HOOK, CONTRE, style: 'hardstyle', ecart: 26, sub: 0.7 }),
});
