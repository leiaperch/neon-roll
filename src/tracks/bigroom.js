...
const HOOK = [
  [[0, 79, 2], [2, 82, 2], [4, 79, 4]],
  [[0, 77, 2], [2, 79, 2], [4, 74, 4]],
  [[0, 82, 2], [2, 86, 2], [4, 82, 4]],
  [[0, 79, 2], [2, 82, 2], [4, 79, 4]],
  [[0, 77, 2], [2, 82, 2], [4, 77, 4]],
  [[0, 74, 2], [2, 77, 2], [4, 79, 4]],
  [[0, 84, 2], [2, 81, 2], [4, 77, 4]],
...
export default piste({
  ...
  pattern: motifEDM({ ACCORDS, BASSE, HOOK, CONTRE, ecart: 22, sub: 0.7 }),
});
